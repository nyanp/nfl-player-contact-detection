...
if __name__ == "__main__":
    ...
    train_tracking = pd.read_csv("../input/nfl-player-contact-detection/train_player_tracking.csv", parse_dates=["datetime"])
    ...
    train_tracking = train_labels.query('nfl_player_id_2 == 0').rename(columns={'nfl_player_id_1': 'nfl_player_id'}).merge(train_tracking, how='left')
