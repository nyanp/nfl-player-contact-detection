# -*- coding: utf-8 -*-
"""
Created on Sun Aug 22 11:13:00 2021
...
class NFLAssignmentScorer:
    def __init__(
        ...
        self.check_iou_only = check_iou_only
    ...
    def add_isCorrect_col(self, sub_labels):
        ...
        """
        if self.check_iou_only:
            sub_labels["isCorrect"] = (sub_labels["iou"] >= self.iou_threshold)
        else:
