...
def load_data(path,
    ...
    flow_files_12 = [rgb_f.replace("train_img", "train_flow_img").replace(".jpg", "flow12.npy") for rgb_f in rgb_files]
    flow_files_21 = [rgb_f.replace("train_img", "train_flow_img").replace(".jpg", "flow21.npy") for rgb_f in rgb_files]
    
    num_files = len(rgb_files)
    dataset = []
    for i, [rgb_file, ann_file, flow_12, flow_21] in enumerate(zip(rgb_files, annotation_files, flow_files_12, flow_files_21)):
