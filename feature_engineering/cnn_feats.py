...
def add_cnn_features(df, cnn_df_dict):
    ...
    if 'camaro1' in cnn_df_dict.keys():
        ...
        camaro1_df = pd.read_csv('../input/camaro-exp139/exp139_val_last_preds.csv')

    if 'camaro1_any' in cnn_df_dict.keys():
        camaro1_any_df = cnn_df_dict['camaro1_any']
    else:
        camaro1_any_df = pd.read_csv('../input/camaro-exp139/exp139_val_last_any_preds.csv')

    if 'camaro2' in cnn_df_dict.keys():
        camaro2_df = cnn_df_dict['camaro2']
    else:
        camaro2_df = pd.read_csv('../input/camaro-exp188/exp188_val_last_preds.csv')

    if 'camaro2_any' in cnn_df_dict.keys():
        camaro2_any_df = cnn_df_dict['camaro2_any']
    else:
        camaro2_any_df = pd.read_csv('../input/camaro-exp188/exp188_val_last_any_preds.csv')
